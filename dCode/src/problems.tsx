...
//       // Fetch user ID
//       const userResponse = await axios.get("http://localhost:3000/api/user");
//       const userId = userResponse.data.auth0_user_id; // Assuming auth0_user_id is the correct field
...
//       for (const problem of response.data) {
//         const statusResponse = await axios.get(
//           `http://localhost:3000/api/user-problem-attempts/${userId}/${problem.problem_id}`
//         );

//         console.log(problem.problem_id);
//         console.log(statusResponse.data[0]?.status || "unstarted");
